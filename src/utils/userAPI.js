  ...
  try {
    ...
    if (Array.isArray(data)) {
      ...
      const transformedBookings = data.map((booking) => {
        ...
        if (booking.showTime) {
          formattedShowTime = parseTimeWithoutTimezone(booking.showTime);
        } else if (booking.show?.formattedShowTime) {
          formattedShowTime = booking.show.formattedShowTime;
        } else if (booking.show?.showTime) {
          formattedShowTime = parseTimeWithoutTimezone(booking.show.showTime);
        }
