...
//   // Load movies, shows, and snacks data
//   useEffect(() => {
//     loadAllData();
//   }, []);
...
//         // Show movies within the chatbot instead of navigating away
//         showMoviesInChat();
//         break;
//       case "view_shows_in_chat":
//         // Show shows within the chatbot
//         showShowsInChat();
//         break;
//       case "view_snacks_in_chat":
//         // Show snacks within the chatbot
//         showSnacksInChat();
//         break;
//       case "view_shows":
...
//           onMovieSelect(data);
//           // Keep chatbot open and show confirmation
//           addBotMessage(
...
//         if (data && onMovieSelect) {
//           onMovieSelect(data);
//           setIsOpen(false); // Only close for external booking
...
//                     <span className="text-gray-200">{action.text}</span>
//                   </button>
//                 ))}
//               </div>
//             </div>
...
// export default FixedChatbotUIMatching;
import React, { useState, useEffect, useRef } from "react";
import {
  MessageCircle,
  X,
