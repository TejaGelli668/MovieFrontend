...
//             <div
//               key={index}
//               className={`bg-gradient-to-br ${stat.color} text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105`}
//             >
...
//                   <span className="text-3xl opacity-80 mb-2">
//                     {stat.bgIcon}
//                   </span>
...
//                   <div
//                     key={movie.id}
//                     className="flex items-center space-x-4 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl hover:shadow-md transition-all"
//                   >
//                     <img
//                       src={movie.poster}
//                       alt={movie.title}
...
//                 <p className="text-gray-500 mt-2">Loading theaters...</p>
//               </div>
...
//                   <div
//                     key={theater.id}
//                     className="p-4 bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl border border-blue-100 hover:shadow-md transition-all"
//                   >
...
//                 <p className="text-gray-500 mb-2">No theaters available</p>
//                 <button
//                   onClick={onNavigateToTheaters}
...
//             </p>
//             <p className="text-sm text-gray-600">Active Theaters</p>
//           </div>
//         </div>
//       </div>
//     </div>
