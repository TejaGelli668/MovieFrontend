...
//         <div>
//           <h2 className="text-3xl font-bold text-white mb-2">Food & Beverages</h2>
...
//           <div className="text-3xl font-bold text-white">{foodItems.length}</div>
...
//                   <span className={`text-sm ${item.isAvailable ? 'text-green-400' : 'text-red-400'}`}>
